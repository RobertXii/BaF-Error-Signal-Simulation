classdef QuantumSimulation
    ...
    properties
        ...
        sigma_L2 = 0.52e-6;          % Variance of the laser pulse [s]
        tspan = linspace(-51.1e-6, 200e-6, 10000);  % Simulation time span (-51.1e-6, 400e-6, 10000)[s]
